...
&НаКлиенте
Процедура ФильтрСвойстваПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	
	ТекущиеДанные = Элементы.ФильтрСвойства.ТекущиеДанные;
	Если НоваяСтрока И Не ЗначениеЗаполнено(ТекущиеДанные.ВидСравнения) Тогда
		ТекущиеДанные.ВидСравнения = Элементы.ФильтрСвойстваВидСравнения.СписокВыбора[0].Значение;
	КонецЕсли;
